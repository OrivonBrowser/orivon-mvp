...
import { Socket, createConnectFactory, kDial, type NetDialFn } from '../socket.js'
import { createFakeTcpSocket, type FakeTcpSocket } from '../../tests/support/fake-tcp-socket.js'
import { socketLifecycleSuite } from '../../tests/support/socket-lifecycle-suite.js'
...
// gets below. This is not a Proxy (unlike net/dns.ts/fs/fs.ts/net/net.ts's
