// net/tls.ts over a stubbed orivon.net.connectSecure -- the same
// globalThis.orivon pattern as http/tests/modules.test.ts. The stub
...
async function tlsModule (): Promise<typeof import('../tls.js')> {
  return await import('../tls.js')
}
