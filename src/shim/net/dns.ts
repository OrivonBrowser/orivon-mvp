...
// (net/isip.ts) is what routes a query there in the first place.
//
...
// (node-errors.ts, already reused by every other capability here)
...
import { systemError, toNodeError } from '../node-errors.js'
