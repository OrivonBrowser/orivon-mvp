...
// DOWN, IN net/isip.ts, NOT HERE: k-rpc-socket (bittorrent-dht's
...
import { codedError, systemError, toNodeError } from '../node-errors.js'
import { toBytes, toBytesJoined } from '../stream-bytes.js'
...
export class Socket extends EventEmitter {
  ...
  // net/socket.ts's own ref/unref/setTimeout methods give: this is a
