...
// TLS-shaped members libraries read. ./tls-options.ts translates the
...
import { Socket, kDial, socketOptionsFrom, type NetDialFn } from './socket.js'
import { normalizeConnectArgs, type ConnectTarget } from './args.js'
