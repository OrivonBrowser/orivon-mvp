// Exercises http/http.ts and http/https.ts themselves -- the module-map
// targets a real `import 'http'`/`import 'https'` resolves to -- rather than
// the shared factory they both wrap (that is http/tests/client.test.ts's
