...
// (handles.ts) http/client.ts consumes -- the same bridge shape a real
...
import { createHttpModule, type ConnectFn } from '../client.js'
...
describe('http/client.ts against a real node:http server', () => {
