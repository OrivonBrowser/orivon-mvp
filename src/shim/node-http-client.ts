...
// node-https.ts. A request travels over a real net.Socket (a TLSSocket for
...
import { serializeRequestHead, defaultHostHeader, type HeaderBag, type HeaderValue } from './node-http-headers.js'
...
import { abortError, codedError, connResetError, toNodeError } from './node-http-errors.js'
import { toBytes } from './node-stream-bytes.js'
import { Socket, kDial, type NetDialFn } from './node-net-socket.js'
import { resolveRequestOptions, type ResolvedRequestOptions } from './node-http-options.js'
