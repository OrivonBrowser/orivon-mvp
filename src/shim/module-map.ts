...
export const SHIM_MODULE_MAP: readonly ShimModuleEntry[] = [
  ...
  { specifier: 'tls', status: 'ready', kind: 'local', implementation: './node-tls.js', note: 'connect()/TLSSocket/checkServerIdentity over orivon.net.connectSecure, honouring ca, rejectUnauthorized, cert/key/pfx/passphrase, servername, ALPNProtocols and a custom checkServerIdentity. secureContext and STARTTLS over an existing socket refuse by name. See README.md and src/shim/tests/node-tls.test.ts.' },
