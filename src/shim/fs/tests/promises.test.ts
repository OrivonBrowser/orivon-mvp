// Exercises fs.promises (fs/promises.ts) directly -- fs/tests/fs.test.ts
// already proves fs/fs.ts's callback family shares the SAME core
// (fs/core.ts), so this file's job is proving the promise surface
...
describe('fs.promises', () => {
  ...
  it('appendFile opens with flags \'a\' -- a real append, sharing fs/core.ts\'s doAppendFile with the callback surface', async () => {
