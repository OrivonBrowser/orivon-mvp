...
// ./web-context-contracts.ts split out of it for ADR-0019, once ADR-0031
 ...
 * policy/derive.ts) -- AND, since ADR-0031, `orivon.secrets`
...
export interface Keychain {
   ...
   * shape `ADR-0031` exists to let an app avoid, so the fail-closed
...
/**
 * `Broker['secrets']` -- ADR-0031, `orivon.secrets`'s broker-internal
