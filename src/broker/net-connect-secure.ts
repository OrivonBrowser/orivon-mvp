// `orivon.net.connectSecure` (ADR-0017), split out of ./net-capability.ts
...
// own state, like ./net-capability.ts, and holds none. README.md's Design
...
export interface ConnectSecureOptions {
  ...
  /** ./net-capability.ts's own wrapper, shared so both paths attach the same handle-table escape hatches (Rule 3). */
