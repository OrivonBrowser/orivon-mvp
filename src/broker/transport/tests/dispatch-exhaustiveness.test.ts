...
import type { AppControlMethod } from '../dispatch-app.js'
...
// dispatch-id.ts, closing the class A185 found in net.listen: a
// ControlMethod member with no matching switch case must not silently
// resolve `undefined` -- a reported success for an operation that never
// ran. ./ipc.ts's own dispatch() and ./dispatch-net.ts's dispatchNet already
// had this guard; this file is its regression test for the three siblings.
//
