...
import { createDatagramRelay } from '../datagram.js'
import { createPortRegistry } from '../port-registry.js'
import type { RegisteredSocket } from '../port-transport.js'
import { fakePort, fakeUdpSocket, tick } from '../../tests/ipc.test-helpers.js'
import type { Datagram } from '../../../../contracts/index.js'

// The wiring that owns one UDP socket's port. transport/relay/tests/socket.test.ts's
...
describe('createDatagramRelay -- teardown fires on every close reason', () => {
  // THE ASYMMETRY WITH transport/relay/socket.ts, asserted rather than described. There,
