...
// ordinary website would. The exchange itself is ./routed-core.ts's.
//
...
import type { FetchRouteTarget, RoutedFetchInit, RoutedFetchRequestLike, RoutedSlot } from './fetch-route-types.js'
