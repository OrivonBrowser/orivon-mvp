...
// over the routed exchange (./routed-core.ts), parsed and reconnected as the
...
// ./routed-wire.ts's header).
import type { FetchRouteTarget, RoutedSlot } from './fetch-route-types.js'
