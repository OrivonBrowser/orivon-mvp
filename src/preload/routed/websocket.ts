...
// (./websocket-frames.ts). A same-origin URL, or a host the app was
...
/** Mirror the literals `installWebSocketRoute` keeps inside its own body; see ./wire.ts's ROUTED_MAX_HEAD_BYTES for why they exist twice. */
