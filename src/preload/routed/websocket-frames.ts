...
// ./wire.ts's header) and publishes `webSocketFrames` on the shared
// slot for ./websocket.ts.
import type { ResponseHead } from './types.js'
import type { WebSocketInbound, WebSocketProtocolError, WebSocketRouteTarget, WebSocketSlot } from './websocket-types.js'
