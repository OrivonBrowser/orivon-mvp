...
// notes describe, where ./routed-dial.ts and ./routed-core.ts pick it up.
import type { ExtractedBody, Framer, FetchRouteTarget, ResponseHead, RoutedSlot } from './fetch-route-types.js'
