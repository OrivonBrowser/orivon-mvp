...
// needs, net and non-net alike -- split out of ./orivon.ts under
// code-guidelines.md Rule 2 so ./net.ts can share it without an
// import cycle back through ./orivon.ts. See ./README.md's Design
