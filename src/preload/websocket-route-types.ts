// Type-only shapes for the routed WebSocket (./websocket-route-frames.ts,
// ./websocket-route.ts). Both installers are serialised into the main world,
// so, like ./fetch-route-types.ts, nothing here may produce JS.
import type { FetchRouteTarget, ResponseHead, RoutedSlot } from './fetch-route-types.js'
...
/** ./websocket-route-frames.ts: the RFC 6455 client codec and the opening handshake. */
