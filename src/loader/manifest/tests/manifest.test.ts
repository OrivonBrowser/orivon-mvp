...
describe('assets', () => {
  ...
  // Belongs to this file rather than fetch/tests/bundle.test.ts because
...
// An unknown TOP-LEVEL field is ignored, not rejected: manifest/tests/unknown-fields.test.ts.
