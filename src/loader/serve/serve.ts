...
import { createRedirectChains, MAX_REACH_REDIRECTS, redirectTarget } from '../reach/redirects.js'
import type { RedirectChains } from '../reach/redirects.js'
import { verifyPinnedTree } from './verify.js'
 ...
 * implementation (`reach/reach.ts`'s `nodeReachDial`) is wired in by
 * electron/serve.ts.
 */
...
export { isNavigationRequest, resolveRequestPath } from './path.js'
export type { ResolvedRequest } from './path.js'
 ...
 * body guarded against a mid-stream revoke (A199, ../reach/guard.js).
