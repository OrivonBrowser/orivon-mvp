...
### Done / results
- 2026-08-26: **The repo is public** — github.com/OrivonBrowser/orivon-mvp, AGPL-3.0-only, full history, CI green on the first run. Branch protection on `main`: CI must pass, changes go through a PR.
