...
| D3 | Licence is **AGPL-3.0-only**, copyright **Davide Martinico** | Owner | 2026-08-26 |
...
| `LICENSE` | May I use this | AGPL-3.0-only, copyright Davide Martinico |
...
`package.json` changes: `"license": "AGPL-3.0-only"` (currently `UNLICENSED`, which legally
