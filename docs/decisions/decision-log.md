...
| `d-0119` | 2026-09-25 | `src/preload/`, `src/shim/`, `src/verifier-host/`, `src/loader/` and `src/broker/` are reorganised into job-named folders, on one rule: a moved file drops the words its new folder already says. Owner | [`ADR-0034`](ADR-0034-src-source-directories-are-organised-by-job.md) |
| `d-0120` | 2026-09-25 | The five-directory reorganisation above lands as one repo-wide sweep on a single branch rather than five, the carve-out A24 asks whether a repo-wide sweep should get. Owner | A24, [`ADR-0034`](ADR-0034-src-source-directories-are-organised-by-job.md), `../development/parallel-work.md` |
