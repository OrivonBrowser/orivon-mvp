...
| `check-size.mjs` | **Rule 2.** No source file over 500 lines, no test file over 800. Not wired into `postinstall` or CI -- code-guidelines.md §Open points #2 leaves that to the owner |
