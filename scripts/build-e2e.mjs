 ...
 * and `npm run package:linux` all call `electron-vite build` directly and
 * never set this flag, so an ordinary or packaged build never carries the
 * path (scripts/check-dev-grant-absent.mjs proves it against the compiled
