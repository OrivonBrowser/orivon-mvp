...
| **Apps come from a URL, not a store** | Visit the address — nothing else to choose. The code is fetched, cached and hash-pinned automatically, then you're asked once, up front, what it may do. No review process, no gatekeeper, no account |
